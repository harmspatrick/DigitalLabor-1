...
_start:
        ...
        .equ dl,10000000               // --> Parameterübergabe Delay
        ldr r10, = 8                 // Dekrement Variable für den Schleifendurchlauf
...
loop:
        ...
        bl Delay
        ldr r2, = IOSET1            // Set of bits with Pointer R2 and IO register IOSET1
        str r0, [r2]

        mov r0, r0, lsl #1          // inkrement with logical leftshift by 1
        subs r10, #1
